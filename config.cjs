...
const config = {
  SESSION_ID: process.env.SESSION_ID || "MASTER-MD&pLk128yU",
  ...
  AUTO_TYPING: process.env.AUTO_TYPING !== undefined ? process.env.AUTO_TYPING === 'false,
  ...
  OWNER_NAME: process.env.OWNER_NAME || "FinestFaisal",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "255629028037",
